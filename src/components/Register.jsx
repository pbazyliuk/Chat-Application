        ...
        <form action="" className="form-sign-up">
          ...
          <div className="form-sign-up__container">
            <div className="form-sign-up__container--narrow">
                ...
                />                              
                <span><span id="firstnameError" className="text-has-error positined-left"></span></span>
              </div>
              ...
              <div className="form-sign-up__container--narrow">
                ...
                onChange={this.handleChange}
                />
                <span id="lastnameError" className="text-has-error positined-right"></span>
              </div>
            </div>
            ...
            <div className="form-sign-up__container">
              ...
              />
              <div id="emailError" className="text-has-error" ></div>
            </div>
            ...
            <div>
              ...
              />
              <div id="passwordError" className="text-has-error" ></div>
            </div>
          ...
          <div className="form-sign-up__container">
            ...
            <div id="passwordConfirmError" className="text-has-error" ></div>
          </div>
        </div>
